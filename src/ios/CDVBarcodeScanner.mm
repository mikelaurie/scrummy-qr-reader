...
processor.promptText = options[@"prompt"];
...
CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.33 green:0.73 blue:0.74 alpha:0.7].CGColor);
CGContextFillRect(context, CGRectMake(0, 0, width, (width/2)));
CGContextFillRect(context, CGRectMake(0, (width/2), (width/4), (width/2)));
...
CGFloat lineOffset = (CGFloat) ((width/4)+(0.5*RETICLE_WIDTH));
CGContextMoveToPoint(context, lineOffset, ((width/4)*3));
CGContextAddLineToPoint(context, width-lineOffset, (CGFloat) ((width/4)*3));
...
//Draw Text
CGRect textRect = CGRectMake((width/8), width+(width/4), (width/8)*6, 200);
NSMutableParagraphStyle* textStyle = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
textStyle.alignment = NSTextAlignmentCenter;

NSDictionary* textFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Helvetica" size: 60], NSForegroundColorAttributeName: UIColor.whiteColor, NSParagraphStyleAttributeName: textStyle};

//NSLog(@"%@", self.processor.promptText);

[self.processor.promptText drawInRect: textRect withAttributes: textFontAttributes];
